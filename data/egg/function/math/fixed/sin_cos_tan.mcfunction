...
## Calculate tan.
scoreboard players operation #egg:-/operation/devide|<<x~fixed -- = #egg:math/fixed/sin_cos_tan|>>sin~fixed --
scoreboard players operation #egg:-/operation/devide|<<y~fixed -- = #egg:math/fixed/sin_cos_tan|>>cos~fixed --
execute store result score #egg:math/fixed/sin_cos_tan|>>tan~fixed -- run function egg:-/operation/devide
