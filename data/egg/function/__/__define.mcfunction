...
execute store result score #egg|pi~fixed -- run function egg:__/point/fixed/from_double
# pi * 1/4 ~fixed
...
## Sqrt ~fixed
# √(1/2)
data modify storage egg:__/point/fixed/from_double <<~double set value 0.7071067812
execute store result score #egg|SQRT(1/2)~fixed -- run function egg:__/point/fixed/from_double

## Coefficient
# 1/2!
data modify storage egg:__/point/fixed/from_double <<~double set value 0.5
execute store result score #egg|1/2!~fixed -- run function egg:__/point/fixed/from_double
# 1/3!
data modify storage egg:__/point/fixed/from_double <<~double set value 0.1666666667
execute store result score #egg|1/3!~fixed -- run function egg:__/point/fixed/from_double
# 1/4!
data modify storage egg:__/point/fixed/from_double <<~double set value 0.04166666667
execute store result score #egg|1/4!~fixed -- run function egg:__/point/fixed/from_double
# 1/5!
data modify storage egg:__/point/fixed/from_double <<~double set value 0.008333333333
execute store result score #egg|1/5!~fixed -- run function egg:__/point/fixed/from_double
# 1/6!
data modify storage egg:__/point/fixed/from_double <<~double set value 0.001388888889
execute store result score #egg|1/6!~fixed -- run function egg:__/point/fixed/from_double

# 1!!/(2!!*3)
data modify storage egg:__/point/fixed/from_double <<~double set value 0.1666666667
execute store result score #egg|1!!/(2!!*3)~fixed -- run function egg:__/point/fixed/from_double
# 3!!/(4!!*5)
data modify storage egg:__/point/fixed/from_double <<~double set value 0.075
execute store result score #egg|3!!/(4!!*5)~fixed -- run function egg:__/point/fixed/from_double
# 5!!/(6!!*7)
data modify storage egg:__/point/fixed/from_double <<~double set value 0.04464285714
execute store result score #egg|5!!/(6!!*7)~fixed -- run function egg:__/point/fixed/from_double
# 7!!/(8!!*9)
data modify storage egg:__/point/fixed/from_double <<~double set value 0.03038194444
execute store result score #egg|7!!/(8!!*9)~fixed -- run function egg:__/point/fixed/from_double
# 9!!/(10!!*11)
data modify storage egg:__/point/fixed/from_double <<~double set value 0.02237215909
execute store result score #egg|9!!/(10!!*11)~fixed -- run function egg:__/point/fixed/from_double

# 1/3
data modify storage egg:__/point/fixed/from_double <<~double set value 0.3333333333
execute store result score #egg|1/3~fixed -- run function egg:__/point/fixed/from_double
# 1/5
data modify storage egg:__/point/fixed/from_double <<~double set value 0.2
execute store result score #egg|1/5~fixed -- run function egg:__/point/fixed/from_double
# 1/7
data modify storage egg:__/point/fixed/from_double <<~double set value 0.1428571429
execute store result score #egg|1/7~fixed -- run function egg:__/point/fixed/from_double

# 6^2/11
data modify storage egg:__/point/fixed/from_double <<~double set value 2.769230769
execute store result score #egg|6^2/11~fixed -- run function egg:__/point/fixed/from_double
