...
## Verify.
execute unless data storage egg:shock/give_by_no_one <<.distance run return run function egg:__/error/throw {message:"[ERROR] function egg:shock/give_by_no_one (5): storage not found (storage egg:shock/give_by_no_one <<.distance)",storage:"egg:shock/give_by_no_one",nbt:"<<.distance"}
execute unless data storage egg:shock/give_by_no_one <<.amount run return run function egg:__/error/throw {message:"[ERROR] function egg:shock/give_by_no_one (6): storage not found (storage egg:shock/give_by_no_one <<.amount)",storage:"egg:shock/give_by_no_one",nbt:"<<.amount"}
