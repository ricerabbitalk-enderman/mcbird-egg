...
execute unless score #egg:shock/__/-give_by_source|damage_only -- matches 0 run function egg:shock/__/macro/-give_illusion_to_target with storage egg:shock <<
execute if score #egg:shock/__/-give_by_source|damage_only -- matches 0 run function egg:shock/__/macro/-give_illusion_and_knockback_to_target with storage egg:shock <<
