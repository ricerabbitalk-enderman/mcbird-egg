...
## Verify.
execute unless data storage egg:shock/give_to_oppositions <<.distance run return run function egg:__/error/throw {message:"[ERROR] function egg:shock/give_to_oppositions (5): storage not found (storage egg:shock/give_to_oppositions <<.distance)",storage:"egg:shock/give_to_oppositions",nbt:"<<.distance"}
execute unless data storage egg:shock/give_to_oppositions <<.amount run return run function egg:__/error/throw {message:"[ERROR] function egg:shock/give_to_oppositions (6): storage not found (storage egg:shock/give_to_oppositions <<.amount)",storage:"egg:shock/give_to_oppositions",nbt:"<<.amount"}
