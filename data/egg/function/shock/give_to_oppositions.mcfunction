...
data modify storage egg:pointer/-enable <<uuid set from storage egg:shock/give_to_oppositions <<.source
...
## Error.
return run function #egg:error {message:"failed give shock to oppositions."}